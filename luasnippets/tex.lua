...
{condition = function() return MoonTex.context() == "math" end }
  ...
  s({trig="ON", wordTrig=true}, {t("\\operatorname{"), i(1), t("}")}, {condition = function() return MoonTex.context() == "math" end }),
  ...
  s({trig = "hat", wordTrig = true}, {t("\\hat{"), i(1), t("}")}, {condition = function() return MoonTex.context() == "math" end }),
  s({trig = "xarr", wordTrig = true}, {t("\\xrightarrow{"), i(1), t("}")}, {condition = function() return MoonTex.context() == "math" end }),
  s({trig = "xarr", wordTrig = true}, {t("\\xrightarrow{"), i(1), t("}")}, {condition = function() return MoonTex.context() == "math" end }),
  ...
  s({trig="map", wordTrig=true}, t("\\mapsto "), {condition = function() return MoonTex.context() == "math" end }),
